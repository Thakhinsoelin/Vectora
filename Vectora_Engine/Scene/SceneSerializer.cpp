...
namespace YAML {
	...
	template<>
	struct convert<Vectora::UUID>
	{
		static Node encode(const Vectora::UUID& uuid)
		{
			Node node;
		...
		static bool decode(const Node& node, Vectora::UUID& uuid)
		{
				...
				if (scriptComponent)
				{
					...
					if (scriptFields)
					{
						...
						for (auto scriptField : scriptFields)
						{
							...
							// TODO(S): turn this assert into log warning
							VE_CORE_ASSERT(fields.find(name) != fields.end());
